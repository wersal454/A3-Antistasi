...
if (_hasHelicopters) then {
    #include "..\DLC_content\vehicles\Helicopters\Vanilla_NATO_Temparate.sqf"
};
...
if (_hasLawsOfWar) then {
    #include "..\DLC_content\gear\Lawsofwar\Vanilla_NATO_Temparate.sqf"
};
...
if (_hasGM) then {
    #include "..\DLC_content\weapons\GM\Vanilla_NATO_Temparate.sqf"
};
//
