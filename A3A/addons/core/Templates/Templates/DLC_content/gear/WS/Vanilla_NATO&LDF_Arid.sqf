...
(_militaryLoadoutData get "uniforms")  append ["U_lxWS_B_CombatUniform_desert", "U_lxWS_B_CombatUniform_desert_tshirt", "U_lxWS_B_CombatUniform_desert_vest","U_lxWS_ION_Casual6","U_lxWS_ION_Casual2","U_lxWS_ION_Casual4"];
(_militaryLoadoutData get "vests") append ["V_lxWS_PlateCarrier1_desert", "V_lxWS_PlateCarrier2_desert","V_Chestrig_khk", "V_TacVest_brn","V_lxWS_TacVestIR_oli","V_lxWS_PlateCarrier1_desert"];
(_militaryLoadoutData get "Hvests") append ["V_lxWS_PlateCarrierSpec_desert","V_lxWS_PlateCarrier2_desert"];
(_militaryLoadoutData get "glVests") append ["V_lxWS_PlateCarrierGL_desert","V_lxWS_PlateCarrier2_desert"];
...
(_militaryLoadoutData get "helmets") append ["H_HelmetSpecB_sand", "H_HelmetB_sand", "H_HelmetB_light_sand","lxWS_H_Booniehat_desert", "lxWS_H_MilCap_desert","lxWS_H_PASGT_goggles_olive_F","lxWS_H_PASGT_goggles_black_F"];
...
(_militiaLoadoutData get "helmets") append ["lxWS_H_bmask_camo02","lxWS_H_PASGT_goggles_olive_F"];
(_militiaLoadoutData get "backpacks") pushBack "B_shield_backpack_lxWS";
