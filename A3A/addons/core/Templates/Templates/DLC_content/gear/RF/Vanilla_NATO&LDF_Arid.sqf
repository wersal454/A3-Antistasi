...
(_militaryLoadoutData  get "atBackpacks") pushBack "B_DuffleBag_MTP_RF";
(_militaryLoadoutData  get "helmets") append ["H_HelmetB_plain_sb_khaki_RF", "H_HelmetB_plain_sb_mtp_RF"];
(_militaryLoadoutData  get "sniHats") append ["H_HelmetB_plain_sb_khaki_RF", "H_HelmetB_plain_sb_mtp_RF"];
...
(_militiaLoadoutData get "helmets") append ["H_HelmetHeavy_Olive_RF","H_HelmetHeavy_Simple_Olive_RF","H_HelmetHeavy_VisorUp_Olive_RF","H_HelmetB_plain_sb_geo_RF"];
(_militiaLoadoutData get "vests") append ["V_TacVest_rig_oli_RF","V_TacVest_rig_blk_RF"];
(_militiaLoadoutData get "Hvests") pushBack "V_PlateCarrierLite_black_noFlag_RF";
(_militiaLoadoutData get "backpacks") append ["B_DuffleBag_Olive_NoLogo_RF","I_E_CommandoMortar_weapon_RF"];
