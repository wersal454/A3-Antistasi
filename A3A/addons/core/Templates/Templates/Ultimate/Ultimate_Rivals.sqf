...
["nameLeader", "SORTEP"] call _fnc_saveToTemplate;
...
private _baseClassCellLeader = ["baseClass", _baseClassCellLeaderArray, true];
private _baseClassMercenary = ["baseClass", _baseClassMercenaryArray, true];
private _baseClassEnforcer = ["baseClass", _baseClassEnforcerArray, true];
private _baseClassPartisan = ["baseClass", _baseClassPartisanArray, true];
private _baseClassMinuteman = ["baseClass", _baseClassMinutemanArray, true];
private _baseClassMedic = ["baseClass", _baseClassMedicArray, true];
private _baseClassSaboteur = ["baseClass", _baseClassSaboteurArray, true];
private _baseClassExplosivesExpert = ["baseClass", _baseClassExplosivesExpertArray, true];
private _baseClassAT = ["baseClass", _baseClassATArray, true];
private _baseClassAA = ["baseClass", _baseClassAAArray, true];
private _baseClassOppressor = ["baseClass", _baseClassOppressorArray, true];
private _baseClassSharpshooter = ["baseClass", _baseClassSharpshooterArray, true];

private _baseClassCrew = ["baseClass", _baseClassCrewArray, true];
private _baseClassPilot = ["baseClass", _baseClassPilotArray, true];
private _baseClassCommander = ["baseClass", _baseClassCommanderArray, true];
...
_loadoutData set ["Rangefinder", _Rangefinder];
...
_loadoutData set ["lightHELaunchers", _rpgsHE];
_loadoutData set ["AALaunchers", _AAlaunchers];
_loadoutData set ["sidearms", _pistols];

_loadoutData set ["uniforms", _uniforms];

_loadoutData set ["heavyUniforms", _heavyUniforms]; ///don't know why it's here but could be useful in the future
...
["minefieldAT", _minesAT] call _fnc_saveToTemplate;
["minefieldAPERS", _minesAPERS] call _fnc_saveToTemplate;
...
private _unitTypes = [
	["CellLeader", _cellLeaderTemplate, [_baseClassCellLeader], [_prefix, true]],
	["Mercenary", _mercenaryTemplate, [_baseClassMercenary], [_prefix, true]],
	["Minuteman", _minutemanTemplate, [_baseClassMinuteman], [_prefix, true]],
	["Enforcer", _enforcerTemplate, [_baseClassEnforcer], [_prefix, true]],
	...
	["Sharpshooter", _sharpshooterTemplate, [_baseClassSharpshooter], [_prefix, true]]
];
...
//    Misc Units    //
//////////////////////
[_prefix, [["Crew", _crewTemplate, [_baseClassCrew], [_prefix, true]]], _crewLoadoutData] call _fnc_generateAndSaveUnitsToTemplate;
[_prefix, [["Pilot", _crewTemplate, [_baseClassPilot], [_prefix, true]]], _pilotLoadoutData] call _fnc_generateAndSaveUnitsToTemplate;
[_prefix, [["Commander", _commanderTemplate, [_baseClassCommander], [_prefix, true]]], _loadoutData] call _fnc_generateAndSaveUnitsToTemplate;
[_prefix, [["Unarmed", _unarmedTemplate, [_baseClassUnarmed], [_prefix, true]]], _loadoutData] call _fnc_generateAndSaveUnitsToTemplate;