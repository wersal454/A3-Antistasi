...
(_pilotLoadoutData get "uniforms") append ["U_C_HeliPilotCoveralls_Black_RF","U_C_HeliPilotCoveralls_Blue_RF"];
(_pilotLoadoutData get "vests") append ["V_TacVest_rig_blk_RF","V_TacVest_rig_khk_RF","V_TacVest_rig_oli_RF"];
(_pilotLoadoutData get "helmets") append ["H_PilotHelmetHeli_Black_RF","H_PilotHelmetHeli_Blue_RF","H_PilotHelmetHeli_White_RF"];
