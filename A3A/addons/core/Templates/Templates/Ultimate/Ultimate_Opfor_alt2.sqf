...
["OPTRE_m1015_mule_mlr_ins_IND", ["12Rnd_230mm_rockets"]] ////if you want to add new artillery you have to define it here
...
#include "Content_Opfor\Ultimate_content_Opfor.sqf"
...
#include "Content_Opfor\Ultimate_content_Opfor_Misc.sqf"
...
["other", [["Official", _SquadLeaderTemplate, []]], _loadoutData] call _fnc_generateAndSaveUnitsToTemplate;
//The following lines are determining the loadout for the AI used in the "kill the traitor" mission
["other", [["Traitor", _traitorTemplate, []]], _loadoutData] call _fnc_generateAndSaveUnitsToTemplate;
//The following lines are determining the loadout for the AI used in the "Invader Punishment" mission
["other", [["Unarmed", _UnarmedTemplate, []]], _loadoutData] call _fnc_generateAndSaveUnitsToTemplate;