class CfgMarkers 
{
	...
	{
		name = "BLUFOR";
		icon = QPATHTOFOLDER(Pictures\Markers\Ultimate_BLUFOR.paa);
		texture = QPATHTOFOLDER(Pictures\Markers\Ultimate_BLUFOR.paa);
	};
	class a3u_flag_OPFOR : flag_NATO 
	{
		name = "OPFOR";
		icon = QPATHTOFOLDER(Pictures\Markers\Ultimate_OPFOR.paa);
		texture = QPATHTOFOLDER(Pictures\Markers\Ultimate_OPFOR.paa);
	};
	class a3u_flag_INDFOR : flag_NATO 
	{
		name = "INDFOR";
		icon = QPATHTOFOLDER(Pictures\Markers\Ultimate_INDFOR.paa);
		texture = QPATHTOFOLDER(Pictures\Markers\Ultimate_INDFOR.paa);
	};
};