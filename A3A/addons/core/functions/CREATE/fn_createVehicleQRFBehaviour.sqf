        ...
        if !(_landPos isEqualTo [0,0,0]) then {
            ...
            if (_vtol) then {
                call selectRandomWeighted [
                    ...
                    {[_vehicle, _cargoGroup, _posDestination, _posOrigin, _crewGroup] spawn A3A_fnc_fastropeVTOL}, 10,
                    {[_vehicle, _cargoGroup, _posDestination, _markerOrigin] spawn A3A_fnc_paradrop}, 40,
                    {[_vehicle, _cargoGroup, _posDestination, _markerOrigin, _resPool] spawn SCRT_fnc_common_paradropVehicle}, 40
                ];
            } else {
                call selectRandomWeighted [
            ...
            if (_vtol) then {
                call selectRandomWeighted [
                    {[_vehicle, _cargoGroup, _posDestination, _posOrigin, _crewGroup] spawn A3A_fnc_fastropeVTOL}, 20,
                    {[_vehicle, _cargoGroup, _posDestination, _markerOrigin] spawn A3A_fnc_paradrop}, 40,
                    {[_vehicle, _cargoGroup, _posDestination, _markerOrigin, _resPool] spawn SCRT_fnc_common_paradropVehicle}, 40
                ];
            } else {
                call selectRandomWeighted [
                    {[_vehicle, _cargoGroup, _posDestination, _posOrigin, _crewGroup] spawn A3A_fnc_fastrope}, 25,
                    {[_vehicle, _cargoGroup, _posDestination, _markerOrigin] spawn A3A_fnc_paradrop}, 75
                ];
            };
        };
    };
